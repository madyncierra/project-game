...
public class MethodMain {
	public static void main(String[] args){
		...
		String Name, Type, Preference, Fight, Death ;
		...
		System.out.println(" ");
		System.out.println("***You ask again...***");
		System.out.println("Where am I?");
		...
		System.out.println("'I mean like, it's harder to tell with newcomers.'");
		System.out.println(" ");
		...
		Type = keyboard.next();
		if(Type != "alien" || Type != "vampire" || Type != "demon" || Type != "witch"){
			System.out.println("Choose 'alien', 'vampire', 'demon', or 'witch'.");
			Type = keyboard.next();
			}
			...
			if (Type.equalsIgnoreCase("alien")){
				...
				if(Preference != "vegetarian" || Preference != "carnivore"){
					System.out.println("'Are you a vegetarian or carnivore?'");
					Preference = keyboard.next();
					...
					if (Preference.equalsIgnoreCase("carnivore")){
						System.out.println(" ");
